% We split our dataset in training and test set so that we can evaluate the
% performances of the models after the training process

% percentage of test set
test_perc = 20;

% num windows for a frame policy 0.128s
num_window = 10;
