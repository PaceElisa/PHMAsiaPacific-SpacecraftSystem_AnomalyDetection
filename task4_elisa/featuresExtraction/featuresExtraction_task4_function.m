...
% Auto-generated by MATLAB on 18-Feb-2025 01:10:35
...
while hasdata(outputEnsemble)
    ...
    % Read signals.
    Case_full = readMemberData(member,"Case",["TIME","P3","P6","P7","P1","P4","P5"]);
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            w = Case_ps.Frequency;
            w = factor*w;
            mask_1 = (w>=factor*30) & (w<=factor*300);
            ps = ps(mask_1);
            w = w(mask_1);
...
selectedFeatureNames = ["FRM_1/Case_sigstats_2/SINAD","FRM_1/Case_sigstats_5/SINAD","FRM_1/Case_sigstats_5/SNR","FRM_1/Case_sigstats_6/SINAD","FRM_1/Case_sigstats_6/SNR","FRM_1/Case_ps_spec/PeakAmp1","FRM_1/Case_ps_spec/PeakFreq2","FRM_1/Case_ps_2_spec/PeakFreq2","FRM_1/Case_ps_3_spec/PeakFreq2","FRM_1/Case_ps_4_spec/PeakFreq1","FRM_1/Case_ps_5_spec/PeakAmp2","FRM_1/Case_ps_5_spec/PeakFreq2","FRM_1/Case_ps_6_spec/PeakAmp2","FRM_1/Case_ps_6_spec/PeakFreq1","FRM_1/Case_ps_6_spec/PeakFreq2"];
