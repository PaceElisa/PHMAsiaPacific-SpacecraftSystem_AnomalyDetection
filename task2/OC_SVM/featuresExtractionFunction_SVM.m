...
% Auto-generated by MATLAB on 29-Jan-2025 13:29:05

% Create output ensemble.
outputEnsemble = workspaceEnsemble(inputData,'DataVariables',"Case",'IndependentVariables',"Label");
...
while hasdata(outputEnsemble)
    ...
    for ct = 1:height(intervals)
        ...
        try
            ...
            w = Case_ps.Frequency;
            w = factor*w;
            mask_1 = (w>=factor*5) & (w<=factor*400);
            ps = ps(mask_1);
            w = w(mask_1);
