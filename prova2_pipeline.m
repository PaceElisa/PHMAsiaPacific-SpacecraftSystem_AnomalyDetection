...
run("C:\Users\Micol\Documents\MATLAB\PHM_Asia_Pacific_Progetto_C1\caricamentoTest.m")

% Features extraction
addpath('task1/');
import features_generation_task1_last.*

%% task 1, dati normali e anormali

% **** Generazione delle feature dei dati di test del task 1 ****
[testFeatureTable1, x1] = features_generation_task1_last(datasetFinaleTest);
