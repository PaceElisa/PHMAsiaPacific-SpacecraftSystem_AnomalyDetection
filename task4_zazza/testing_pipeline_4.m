% Loading of the test dataset composed of valve anomalies, obtained by filtering
...
%% Valve Anomalies Classification
...
% VOTING_SYSTEM_TASK3 - Aggrega le predizioni per il Task 4 utilizzando il metodo della maggioranza
%
% INPUT:
