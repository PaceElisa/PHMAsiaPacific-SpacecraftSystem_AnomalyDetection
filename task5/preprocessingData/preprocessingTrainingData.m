...
% with values that rappresent the opening ratio of soleniod valve 
...
for i = 1:numel(data)
    ...
    elseif labelsTable{i,"SV1"} ~= 100
        trainingData{i,2} = labelsTable{i,"SV1"};
    elseif labelsTable{i,"SV2"} ~= 100
        trainingData{i,2} = labelsTable{i,"SV2"};
    elseif labelsTable{i,"SV3"} ~= 100
        trainingData{i,2} = labelsTable{i,"SV3"};
    elseif labelsTable{i,"SV4"} ~= 100
        trainingData{i,2} = labelsTable{i,"SV4"};
    end  
